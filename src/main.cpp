...
int main(int argc, char *argv[])
{
    ...
    risip::RisipApplicationSettings::instance()->setOrganizationName(QString("risipapp"));
    risip::RisipApplicationSettings::instance()->setApplicationName(QString("risipapp"));
